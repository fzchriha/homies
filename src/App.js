...
import "./App.css";
import USMap, { months, stateMatches } from "./USMap";
...
function App() {
  ...
  const [statesWithinBudget, setStatesWithinBudgets] = React.useState([]);
  ...
  return (
    <div className="App">
          ...
          <p className="main-paragraph">
            ...
            >
              ...
              <Autocomplete
                id="free-solo-3-demo"
                disableClearable
                sx={{ marginX: 3, width: 400, borderRadius: 20 }}
                ...
                renderInput={(params) => (
                  <TextField
                    {...params}
                    label="What month are you moving in?"
                    className="input"
                    color="secondary"
                    sx={{ borderRadius: 5 }}
                    InputProps={{
              ...
              <Fab
                color="secondary"
                aria-label="add"
                disabled={!month || !budget}
                onClick={() => {
                  const matches = stateMatches(month, parseInt(budget));
                  setStatesWithinBudgets(matches);
                }}
              >
                <SearchIcon />
              </Fab>
      ...
      <USMap highlightedStates={statesWithinBudget} />
